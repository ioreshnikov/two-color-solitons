...
.PHONY: seed_npz
seed_npz: 1.064_seed.npz 1.000_seed.npz 1.100_seed.npz 1.080_seed.npz \
          1.064_fsg.npz 1.000_fsg.npz 1.100_fsg.npz 1.080_fsg.npz
...
1.100_2.720.npz: data venv 1.100_seed.npz
...
# A fine-spatial-grid (FSG) sample of the previous solution
1.100_2.720_fsg.npz: data venv 1.100_2.720.npz
...
# A scattering that should show a lot of secondary resonances
1.100_3.370.npz: data venv 1.100_seed.npz
...
# A fine-spatial-grid (FSG) sample of the previous solution
1.100_3.370_fsg.npz: data venv 1.100_3.370.npz
...
# A scattering that should show a lot of secondary resonances
1.080_3.250.npz: data venv 1.080_seed.npz
...
# A fine-spatial-grid (FSG) sample of the previous solution
1.080_3.250_fsg.npz: data venv 1.080_3.250.npz
...
scattering_npz: 1.064_1.700.npz 1.100_2.720.npz 1.100_3.370.npz 1.080_3.250.npz \
                1.064_1.700_fsg.npz 1.100_2.720_fsg.npz 1.100_3.370_fsg.npz 1.080_3.250_fsg.npz
